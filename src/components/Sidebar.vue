<template>
  ...
  >
    ...
    <v-list density="compact" nav>
      ...
      <v-list-item prepend-icon="mdi-calculator" title="LOYIHALAR VA TIJORATLASHTIRISH" value="projects" @click="this.$router.push({name: 'Projects'})"></v-list-item>
      <v-list-item prepend-icon="mdi-star-box-multiple" title="IXTIROCHILIK VA RATSIONALIZATORLIK" value="invention" @click="this.$router.push({name: 'Invention'})"></v-list-item>
