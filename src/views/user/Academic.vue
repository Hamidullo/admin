...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm () {
      this.overlay = true
      axios.delete(`http://172.16.10.3:3002/api/academics/delete?id=${this.editedItem.id}&newId=${this.editedItem.newId}`)
        .then(response => {
    ...
    deleteCItemConfirm () {
      this.overlay = true
      axios.delete(`http://172.16.10.3:3002/api/academics/delete?id=${this.editedCItem.id}&newId=${this.editedCItem.newId}`)
        .then(response => {
    ...
    deleteSItemConfirm () {
      this.overlay = true
      axios.delete(`http://172.16.10.3:3002/api/academics/delete?id=${this.editedSItem.id}&newId=${this.editedSItem.newId}`)
        .then(response => {
    ...
    async save () {
      ...
      if (valid) {
        if (this.editedIndex > -1) {
          ...
          await axios.put("http://172.16.10.3:3002/api/academics/update?id="+this.editedItem.id, data)
            .then(response => {
          ...
          await axios.post("http://172.16.10.3:3002/api/academics/create?userId="+this.userId, formData)
            .then(response => {
              console.log(response.data)
    ...
    async saveC () {
      ...
      if (valid){
        if (this.editedCIndex > -1) {
          ...
          await axios.put("http://172.16.10.3:3002/api/academics/update?id="+this.editedCItem.id, data)
            .then(response => {
              console.log(response.data)
    ...
    async saveS () {
      ...
      if (valid){
        if (this.editedSIndex > -1) {
          ...
          axios.put("http://172.16.10.3:3002/api/academics/update?id="+this.editedSItem.id, data)
            .then(response => {
              console.log(response.data)
          ...
          axios.post("http://172.16.10.3:3002/api/academics/create?userId="+this.userId, formData)
            .then(response => {
              console.log(response.data)
    ...
    downloadDoc(item) {
      ...
      this.downloadWithAxios("http://172.16.10.3:3002/api/academics/download?userId="+item.userId+"&file="+item.doc,item.doc)
    },
  },
  ...
  async mounted() {
    await axios
      .get(`http://172.16.10.3:3002/api/academics/type?userId=${this.userId}&limit=10&offset=0&type=11`)
      .then(response => {
    ...
    await axios
      .get(`http://172.16.10.3:3002/api/academics/type?userId=${this.userId}&limit=10&offset=0&type=12`)
      .then(response => {
        const data  = response.data
        for (const dataKey in data) {
          if (data[dataKey].news === 1){
    ...
    await axios
      .get(`http://172.16.10.3:3002/api/academics/type?userId=${this.userId}&limit=10&offset=0&type=13`)
      .then(response => {
        const data  = response.data
        for (const dataKey in data) {
          if (data[dataKey].news === 1){
