<template>
  <v-container class="py-8 px-6 bg-grey-lighten-2" align="center" justify="center" fluid>
    ...
    <v-row align="center" justify="center" >
      <v-col cols="6">
        <v-card class="chart" >
          <PlanetChart class="chart" :planet-data="planetChartData"/>
        </v-card>
      </v-col>

      <v-col cols="6">
        <v-card class="chart" >
          <PlChart class="chart" :planet-data="planetChartData2"/>
        </v-card>
      </v-col>

      <v-col cols="6" >
        <v-card class="chart" >
          <PChart :planet-data="planetChartData3"/>
        </v-card>
      </v-col>

      <v-col cols="6">
        <v-card class="chart" >
          <UChart :planet-data="planetChartData3"/>
        </v-card>
      </v-col>
